...
import L from 'leaflet';
import 'leaflet/dist/leaflet.css';
import customerIconUrl from './user.png'; // Import your user icon here
import driverIconUrl from './truck-solid.svg'; // Import your user icon here
import dustbinIconUrl from './trash-solid.svg'; // Import your user icon here
    ...
    const MapComponent = () => {
        ...
        useEffect(() => {
            ...
            function success(pos) {
                ...
                const accuracy = pos.coords.accuracy;
                const driver_lat = 27.67142; // Replace with your desired coordinates
                const driver_lng = 85.33980; // Replace with your desired coordinates

                const driverIcon = L.icon({
                    iconUrl: 'garbage_truck.png', // Replace with the correct path to your driver icon
                    iconSize: [38, 50],
                    iconAnchor: [22, 94],
                    popupAnchor: [-3, -76],
                });
                ...
                const userIcon = L.icon({
                    iconUrl: customerIconUrl, // Use the imported user icon here
                    iconSize: [38, 38],
                    iconAnchor: [22, 94],
                    popupAnchor: [-3, -76],
                });
        ...
        return (
            <div>
                <Box m="20px">
                    <Header title="LIVE LOCATION" subtitle="Map Is Coming Soon" />
                </Box>
                <h1 style={{ textAlign: 'center' }}>Map User Location</h1>
                <div id="map" style={{ height: '850px' }}></div>
            </div>
